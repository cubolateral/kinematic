...
pub fn derive_container(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    quote::quote! {
        impl kinematic::core::objects::Container for #object_name {}
        ...
        impl #handler_name {
            ...
            pub fn add(&self, handler: &impl kinematic::core::objects::ObjectHandler) {
                <Self as kinematic::core::objects::ContainerHandler>::add(self, handler);
            }
            ...
            pub fn get_child_entity(
                ...
                <Self as kinematic::core::objects::ContainerHandler>::get_child_entity(self, index)
            }
            ...
            pub fn get_child<T: kinematic::core::objects::Object + 'static>(
                ...
                <Self as kinematic::core::objects::ContainerHandler>::get_child::<T>(self, index)
            }
        }

        impl kinematic::core::objects::ContainerHandler for #handler_name {
